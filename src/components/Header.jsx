      ...
      <div className="max-w-full mx-auto px-3 py-2.5">
        <div className="flex justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-2 min-w-0 flex-1">
            <button onClick={onMenuClick} className="md:hidden text-white text-xl flex-shrink-0">
              ☰
            </button>
          ...
          <div className="relative flex-shrink-0">
            ...
            >
              ...
              <span className={`text-[10px] font-bold capitalize hidden md:block`}>
                {userRole}
              </span>
        ...
        {/* Event details - second line on mobile */}
        {event && (
